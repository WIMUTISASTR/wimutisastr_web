  ...
  const testimonials = [
    {
      ...
      content: "វគ្គវីដេអូដ៏គ្រប់ជ្រុងជ្រោយនេះបានផ្តល់ចំណេះដឹងដ៏មានតម្លៃអំពីប្រព័ន្ធច្បាប់។ ការរៀបចំមាតិកា និងការបង្រៀនពីអ្នកជំនាញបានជួយខ្ញុំយ៉ាងខ្លាំងក្នុងការអភិវឌ្ឍអាជីព។",
      avatar: "SC",
      rating: 5,
    },
    {
